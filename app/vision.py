...
mpmalla = mp_face_mesh.FaceMesh(max_num_faces=1)
    ...
    if resultados.multi_face_landmarks:
        for rostros in resultados.multi_face_landmarks:
            ...
            mpfm.draw_landmarks(
                ...
                landmark_drawing_spec=cdj,
                connection_drawing_spec=mpfm.DrawingSpec((255, 0, 0), thickness=t, circle_radius=r)
            )
        ...
        if len(px) != 0 and len(py) != 0:
            ...
            cv2.putText(frame, 'Rostro', (x1 - 30, y1 - 30), cv2.FONT_HERSHEY_SIMPLEX,
                        1, (0, 255, 0), 2)
    else:
